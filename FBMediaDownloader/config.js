...
export const WAIT_BEFORE_NEXT_FETCH = 2000; // thời gian chờ (ms) trước mỗi lần fetch tiếp theo
...
export const FOLDER_TO_SAVE_COMMENT_POST = "downloads/post_comment";
